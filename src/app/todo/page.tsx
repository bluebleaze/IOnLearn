            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-1.5 text-xs rounded-lg bg-slate-50 dark:bg-[#1f1f1f] border-0 text-slate-800 dark:text-[#e5e5e5] focus:outline-none focus:ring-1 focus:ring-indigo-500/30"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 text-xs rounded-lg bg-slate-50 dark:bg-[#1f1f1f] border-0 text-slate-800 dark:text-[#e5e5e5] focus:outline-none focus:ring-1 focus:ring-indigo-500/30 placeholder:text-slate-400 dark:placeholder:text-[#666]"
                />
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-[#191919] p-1 rounded-xl text-xs overflow-x-auto no-scrollbar">
            <button
              ...
              className={`min-h-[44px] sm:min-h-0 px-3 py-2 sm:py-1.5 rounded-lg font-medium transition-all cursor-pointer whitespace-nowrap flex items-center justify-center ${
                filterTab === "all"
            ...
            <button
              ...
              className={`min-h-[44px] sm:min-h-0 px-3 py-2 sm:py-1.5 rounded-lg font-medium transition-all cursor-pointer whitespace-nowrap inline-flex items-center justify-center gap-1 ${
                filterTab === "high"
          ...
          <div className="w-full sm:w-64">
            <input
              ...
              className="w-full px-3 py-2.5 sm:py-1.5 text-xs rounded-xl bg-slate-100 dark:bg-[#191919] border-0 text-slate-900 dark:text-[#f3f3f3] placeholder:text-slate-400 dark:placeholder:text-[#666] focus:outline-none"
            />
          </div>
        </div>
